...
@pytest.mark.asyncio
async def test_pipe_with_async_function():
    result = await pipe(5, async_increment)
    assert result == 6


@pytest.mark.asyncio
async def test_pipe_with_sync_function():
    result = await pipe(5, sync_multiply)
    assert result == 10


@pytest.mark.asyncio
async def test_pipe_with_combined_functions():
    result = await pipe(5, async_increment, sync_multiply)
    assert result == 12


@pytest.mark.asyncio
async def test_pipe_with_multiple_async_functions():
    result = await pipe(5, async_increment, async_add)
    assert result == 9


@pytest.mark.asyncio
async def test_pipe_with_mixed_functions():
